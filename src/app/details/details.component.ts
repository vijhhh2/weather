...
export class DetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.activeRouter.paramMap.subscribe((route: any) => {
      ...
      this.sub2 = this.weather.getCurrentTemp(this.city)
      .subscribe((temp) => this.temp = temp);
      this.sub3 = this.weather.getCurrentHum(this.city)
      .subscribe((humidity) => this.hum = humidity);
      this.sub4 = this.weather.getCurrentWind(this.city)
      .subscribe((windspeed) => this.wind = windspeed);
      this.sub5 = this.weather.getForecast(this.city)
      .subscribe((data: any) => {
        console.log(data);
